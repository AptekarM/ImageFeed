...
final class ProfileViewController: UIViewController {
    ...
    private func updateAvatar() {
        ...
        // Настройка обработчика RoundCornerImageProcessor
        let processor = RoundCornerImageProcessor(cornerRadius: 20)
        
        // Загрузка изображения с помощью Kingfisher с указанием заполнителя и обработчика
        profileImageView?.kf.setImage(
            ...
            options: [
                ...
                .scaleFactor(UIScreen.main.scale) // Загрузка с более высоким масштабом качества
            ]
        )
    }
